...
const About = () => {
  return (
    <section
      id="about"
      className="h-screen flex px-6 py-20 bg-[#0b043a] text-white"
    >
      <div className="flex w-[40%]">
        <div className=" relative w-[80%] bg-[#1B1448] ring-1 ">
          <img
          ...
          />
          <div className="flex pl-10 w-full absolute bottom-5 gap-5  text-2xl">
            <FaTwitter /> <FaFacebook /> <IoLogoDiscord /> <SiYoutube />
          </div>
        </div>
      </div>
      <div className="flex w-[60%] flex-col gap-4 items-center justify-center">
